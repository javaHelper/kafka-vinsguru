    ...
    public InventoryEvent newOrderInventory(OrderEvent orderEvent){
        ...
        return inventoryRepository.findById(orderEvent.getPurchaseOrder().getProductId())
                ...
                .map(i -> {
                    ...
                    OrderInventoryConsumption oIc = OrderInventoryConsumption.of(orderEvent.getPurchaseOrder().getOrderId(), orderEvent.getPurchaseOrder().getProductId(), 1);
                    consumptionRepository.save(oIc);
